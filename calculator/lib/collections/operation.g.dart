...
extension OperationQueryFilter
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionEqualTo(
    String value, {
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Operation, Operation, QAfterFilterCondition> questionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'question',
        value: '',
...
extension OperationQuerySortBy on QueryBuilder<Operation, Operation, QSortBy> {
  QueryBuilder<Operation, Operation, QAfterSortBy> sortByQuestion() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'question', Sort.asc);
    });
  }

  QueryBuilder<Operation, Operation, QAfterSortBy> sortByQuestionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension OperationQuerySortThenBy
  ...
  QueryBuilder<Operation, Operation, QAfterSortBy> thenByQuestion() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'question', Sort.asc);
    });
  }

  QueryBuilder<Operation, Operation, QAfterSortBy> thenByQuestionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'question', Sort.desc);
    });
  }
...
extension OperationQueryWhereDistinct
  ...
  QueryBuilder<Operation, Operation, QDistinct> distinctByQuestion(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension OperationQueryProperty
  ...
  QueryBuilder<Operation, String, QQueryOperations> questionProperty() {
    return QueryBuilder.apply(this, (query) {
